...
extension CLI {
    struct Find: ParsableCommand {
        static var configuration
            = CommandConfiguration(abstract: "Find references of a specific symbol")
    ...
    struct Dump: ParsableCommand {
        static var configuration
            = CommandConfiguration(abstract: "Dump symbols from a module")
...
struct CLI: ParsableCommand {
    static var configuration = CommandConfiguration(
        commandName: "clue",
        version: version,
        subcommands: [Find.self, Dump.self]
    )
}

extension OutputFormat: ExpressibleByArgument {}
extension IndexSymbolKind: ExpressibleByArgument {
